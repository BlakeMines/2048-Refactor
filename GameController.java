...
public abstract class GameController implements EventListener {
    ...
    public void up() { model.up(); }
    public void down() { model.down(); }

	/**
        Either keyController or MouseController will be
        the input listener of the View.
        I cannot decide now.
        Let the subclass register itself as the listener.
    */

    protected abstract void setViewListener(View v);
    protected abstract void action(InputEvent e);

    public void initialize(View view, Model model){
        this.view=view;
        this.model=model;
        /** other initializations if needed */
        setViewListener(view); //keylistener or mouse listener of view
    }
